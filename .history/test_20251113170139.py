...
# Desafio 3: Escolhas Seguras (Múltipla Escolha com Explicação) [3]
    ...
    q4 = Questao("Você recebe um e-mail pedindo a senha da sua conta com um link suspeito. O que você deve fazer?") 
    q4.adicionar_alternativa(Alternativa("Responder com sua senha")) 
    q4.adicionar_alternativa(Alternativa("Ignorar e denunciar o e-mail", e_correta=True)) 
    q4.adicionar_alternativa(Alternativa("Clicar no link para ver o que diz"))  
    desafios.append(q4)

    # ⚡ Desafio 5: Rodada Rápida (Desafio do Cronômetro) [4]
    q5 = Questao("Você tem 20 segundos! Qual é a senha mais forte?") 
    q5.adicionar_alternativa(Alternativa("password123")) 
