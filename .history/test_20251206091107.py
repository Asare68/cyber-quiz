...
def create_quiz():
    ...
    q6 = Question("What's the best way to remember complex passwords?")
    q6.add_alternative(Alternative("Use a password manager", is_correct=True))
    q6.add_alternative(Alternative("Write them down on paper"))
    q6.add_alternative(Alternative("Use simple passwords"))
    quiz.append(q6)

    # Fixed q7 - proper question and alternatives
    q7 = Question("What is a weak password?")
    q7.add_alternative(Alternative("Easy to guess or commonly used like '123456' or 'password'", is_correct=True))
    q7.add_alternative(Alternative("I'm something you must keep secret. "))
    q7.add_alternative(Alternative("Made of letters, numbers, maybe symbols too. "))
    quiz.append(q7)
    
    # Fixed bonus riddle question
    riddle_text = "I'm the key to your account—you need me to get in. What am I?"
